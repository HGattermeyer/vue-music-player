...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_message: "Please wait! Submitting comment.",
      schema: {
  ...
  methods: {
    ...
    async addComent(values, { resetForm }) {
      ...
      this.comment_alert_message = "Please wait! Submitting comment.";
      ...
      this.comment_alert_message = "Comment submitted with success!";
